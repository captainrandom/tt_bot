import cmbot from 'cmbot'
import * as path from 'path'

const modulesDir = __dirname + 'src/modules'
const botDir = path.join(__dirname, 'bots', process.env.BOTNAME)
const botDbFile = path.join(botDir, 'mybot.db')
...
const mybot = new cmbot({
  ...
  settings_file: botDir + '/settings.json',
  dj_file: botDir + '/djs.json',
